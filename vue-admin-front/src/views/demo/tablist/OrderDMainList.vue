  ...
  <a-card :bordered="false">
    ...
    <a-tabs defaultActiveKey="1">
      <a-tab-pane tab="客户信息" key="1">
        <Order-Customer-List ref="JeecgOrderCustomerList"></Order-Customer-List>
      </a-tab-pane>
      <a-tab-pane tab="机票信息" key="2" forceRender>
        <Order-Ticket-List ref="JeecgOrderTicketList"></Order-Ticket-List>
      </a-tab-pane>
    </a-tabs>

    <!-- 表单区域 -->
    <orderDMain-modal ref="modalForm" @ok="modalFormOk"></orderDMain-modal>

  </a-card>
</template>

<script>
  import OrderDMainModal from './form/OrderDMainModal'
  import OrderCustomerList from './OrderCustomerList'
  import OrderTicketList from './OrderTicketList'
  import {deleteAction} from '@/api/manage'
  import OrderCustomerModal from './form/OrderCustomerModal'
  import OrderTicketModal from './form/OrderTicketModal'
  import {CustomerListMixin} from '@/mixins/CustomerListMixin'

  export default {
    name: "OrderDMainList",
    mixins: [CustomerListMixin],
    components: {
      OrderTicketModal,
      OrderCustomerModal,
      OrderDMainModal,
    ...
    data() {
      return {
        ...
        type: "radio",
        url: {
          list: "/test/orderMain/list",
          delete: "/test/orderMain/delete",
          deleteBatch: "/test/orderMain/deleteBatch",
        },
      }
    },
    methods: {
