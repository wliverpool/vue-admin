<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <OrderTicket-modal ref="modalForm" @ok="modalFormOk"></OrderTicket-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/test/orderMain/listOrderTicketByMainId",
          delete: "/test/orderMain/deleteTicket",
          deleteBatch: "/test/orderMain/deleteBatchTicket",
        }
      }
    },
    methods: {
