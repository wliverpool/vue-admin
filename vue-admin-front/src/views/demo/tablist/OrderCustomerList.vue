<template>
  <a-card :bordered="false">
    ...
    <!-- table区域-end -->
    <!-- 表单区域 -->
    <orderCustomer-modal ref="modalForm" @ok="modalFormOk"></orderCustomer-modal>
  </a-card>
</template>

<script>
  import OrderCustomerModal from './form/OrderCustomerModal'
  import OrderDMainList from './OrderDMainList'
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          list: "/test/orderMain/listOrderCustomerByMainId",
          delete: "/test/orderMain/deleteCustomer",
          deleteBatch: "/test/orderMain/deleteBatchCustomer",
        }
      }
    },
    methods: {
