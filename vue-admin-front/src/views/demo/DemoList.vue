<template>
  <a-card :bordered="false">
    ...
    <!-- 一对多表单区域 -->
    <demoTabsModal ref="jeecgDemoTabsModal" @ok="modalFormOk"></demoTabsModal>
...
<script>
  ...
  import JSuperQuery from '@/components/demo/JSuperQuery.vue';
  import JInput from '@/components/demo/JInput.vue';
  import DemoTabsModal from './modules/DemoTabsModal'
  ...
  export default {
    ...
    methods: {
      ...
      //跳转单据页面
      jump() {
        this.$router.push({path: '/demo/PrintDemo'})
      },
