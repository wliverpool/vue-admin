...
<script>
  ...
  import JSelectDepart from '@/components/biz/JSelectDepart'
  import JSelectUserByDep from '@/components/biz/JSelectUserByDep'
  import JSelectMultiUser from '@/components/biz/JSelectMultiUser'
  import JSelectRole from '@/components/biz/JSelectRole'
  import JCheckbox from '@/components/demo/JCheckbox'
  import JCodeEditor from '@/components/demo/JCodeEditor'
  import JDate from '@/components/demo/JDate'
  import JEditor from '@/components/demo/JEditor'
  import JEllipsis from '@/components/demo/JEllipsis'
  import JSlider from '@/components/demo/JSlider'
  import JSelectMultiple from '@/components/demo/JSelectMultiple'
  import JTreeDict from "../../components/demo/JTreeDict.vue";
  import JCron from "@/components/demo/JCron.vue";
  import JTreeSelect from '@/components/demo/JTreeSelect'
  import JSuperQuery from '@/components/demo/JSuperQuery'
  import JUpload from '@/components/demo/JUpload'
  import JImageUpload from '@/components/demo/JImageUpload'
  import JSelectPosition from '@comp/biz/JSelectPosition'
  import JCategorySelect from '@comp/demo/JCategorySelect'
  import JMultiSelectTag from '@comp/dict/JMultiSelectTag'
  import JInput from '@comp/demo/JInput'
  import JAreaLinkage from '@comp/demo/JAreaLinkage'
  import JMarkdownEditor from '@/components/demo/JMarkdownEditor/index'
