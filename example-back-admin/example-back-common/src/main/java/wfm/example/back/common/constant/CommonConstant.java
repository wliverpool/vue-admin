package wfm.example.back.common.constant;
...
public class CommonConstant {
    ...
    /** 登录用户权限缓存KEY前缀 */
    public static String PREFIX_USER_AUTH_CACHE  = "auth:cache:authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
    ...
    public final static String X_ACCESS_TOKEN_NEW = "X-Access-Token_New";
