...
import wfm.example.back.activiti.vo.HistoricProcessInsVo;
import wfm.example.back.activiti.vo.ProcessInsVo;
...
public class ActProcessInsController {
    ...
    /**
     * 通过流程定义id获取第一个任务节点，包含可供选择的审批人、网关信息等
     * @param procDefId 流程定义Id
     * @param tableName 表名
     * @param tableId 表id
     */
    @RequestMapping(value = "/getFirstNode", method = RequestMethod.GET)
    public Result getFirstNode(String procDefId, String tableName, String tableId){
