...
public class ActivitiProcessController {
     ...
     * @param lckey  流程key
     * @param zx  是否最新
     * @param status  流程状态 部署后默认1激活
     * @param roles 如果此项不为空，则会过滤当前用户的角色权限
     * @param request
     * @return
     */
    @RequestMapping(value = "/listData" ,method = RequestMethod.GET)
    public Result listData(String lcmc, String lckey, Boolean zx, String status, Boolean roles, HttpServletRequest request,@AuthenticationPrincipal UserDetails userDetails){
        log.info("-------------流程列表-------------");
     ...
     * @param currActId 当前节点定义id
     * @param procInstId 当前节点定义id
     * @return
     */
    @RequestMapping(value = "/getNextNode", method = RequestMethod.GET)
    public Result getNextNode(String procDefId, String currActId, String procInstId){
    ...
    public Result getNode(@RequestParam("nodeId") String nodeId, @RequestParam("tableName") String tableName, @RequestParam("tableId") String tableId){
    ...
    public Result queryNewestProcess(@RequestParam(value = "processKey",defaultValue = "") String processKey){
