...
import wfm.example.back.wx.model.multicustservice.ChatRecord;
import wfm.example.back.wx.model.multicustservice.CustService;
 ...
 * @author 吴福明
 */
public class JwMultiCustomerUtils {
