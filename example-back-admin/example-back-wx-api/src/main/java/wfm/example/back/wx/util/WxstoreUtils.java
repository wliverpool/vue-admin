...
import wfm.example.back.wx.common.MyX509TrustManager;
...
public class WxstoreUtils {
    ...
    public static JSONObject httpRequest(String requestUrl,
        ...
        log.debug("*********HTTPREQUEST START********");
        log.debug("*********requestUrl is "+
        ...
        try {
            ...
            if (jsonObject.containsKey("errcode") && jsonObject.getInt("errcode") != 0) {
                log.error("********* ERROR********{}",buffer.toString());
                log.error("*********HTTPREQUEST END********");
