...
import wfm.example.back.wx.model.dingtalk.GetUserListBody;
...
public class JdtUserUtils {
    ...
    public static Response<String> create(User user, String accessToken) {
        ...
        Response<JSONObject> originResponse = HttpUtils.post(url, JSON.toJSONString(user));
        ...
        log.info("[USER_CREATE] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<JSONObject> update(User user, String accessToken) {
        ...
        Response<JSONObject> response = HttpUtils.post(url, JSON.toJSONString(user));
        log.info("[USER_UPDATE] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<JSONObject> delete(String userid, String accessToken) {
        ...
        log.info("[USER_DELETE] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static List<Response<JSONObject>> batchDeletePseudo(Collection<String> userIds, String accessToken) {
        ...
        for (String userId : userIds) {
            list.add(JdtUserUtils.delete(userId, accessToken));
        }
        return list;
    }
    ...
    public static Response<User> getUserById(String userid, String accessToken) {
        ...
        JSONObject body = new JSONObject();
        body.put("userid", userid);
        Response<User> response = HttpUtils.post(url, body.toJSONString(), User.class);
        log.info("[USER_GET_BY_ID] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<PageResult<User>> getUserListByDeptId(GetUserListBody body, String accessToken) {
        ...
        Response<PageResult<User>> response = HttpUtils.post(url, JSON.toJSONString(body), JdtTypes.PageResult_User);
        log.info("[USER_GET_LIST_BY_DEPT_ID] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<PageResult<User>> getUserListSimpleByDeptId(GetUserListBody body, String accessToken) {
        ...
        Response<PageResult<User>> response = HttpUtils.post(url, JSON.toJSONString(body), JdtTypes.PageResult_User);
        log.info("[USER_GET_LIST_SIMPLE_BY_DEPT_ID] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<List<String>> getUserListIdByDeptId(int deptId, String accessToken) {
        ...
        Response<JSONObject> originResponse = HttpUtils.post(url, JSON.toJSONString(body));
        ...
        log.info("[USER_GET_LIST_ID_BY_DEPT_ID] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<Integer> getUserCount(boolean onlyActive, String accessToken) {
        ...
        log.info("[USER_COUNT] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<Integer> getUserCount(String accessToken) {
        return JdtUserUtils.getUserCount(false, accessToken);
    }
    ...
    public static Response<String> getUseridByMobile(String mobile, String accessToken) {
        ...
        log.info("[USER_GET_ID_BY_MOBILE] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<String> getUseridByUnionid(String unionid, String accessToken) {
        ...
        log.info("[USER_GET_ID_BY_UNIONID] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
