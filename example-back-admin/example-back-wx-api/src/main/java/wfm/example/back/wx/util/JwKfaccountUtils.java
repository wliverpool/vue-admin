...
import wfm.example.back.wx.model.kfaccount.*;
import wfm.example.back.wx.model.wxsendmsg.WxKfaccount;
...
public class JwKfaccountUtils {
    ...
    public static void main(String[] args){
        try {
            ...
            List<WxKfaccount> ls = JwKfaccountUtils.getAllOnlineKfaccount(s);
