...
import wfm.example.back.wx.model.user.*;
...
public class JwGroupUtils {
    ...
    private static void getAccessToken(){
        try {
            System.out.println(TOKEN=JwTokenUtils.getAccessToken("wxd2b52b8f4bd5af7f","1b982dba2c3f853c3396babcdfa6cb1e"));
    ...
    private static void testCreateGroup(){
        GroupCreate group;
        try {
            group = JwGroupUtils.createGroup(TOKEN, "分组2017");
    ...
    private static void testUpdateGroup(){
        String errmsg;
        try {
            errmsg = JwGroupUtils.updateGroup(TOKEN,"106","分组20172");
    ...
    private static void testGetAllGroup(){
        ...
        try {
            groupList = JwGroupUtils.getAllGroup(TOKEN);
    ...
    private static void testGetUserGroup(){
        ...
        try {
            ...
            String groupid = JwGroupUtils.getUserGroup(TOKEN,openid);
    ...
    private static void testGroupMemberMove(){
        ...
        try {
            String groupid = JwGroupUtils.groupMemberMove(TOKEN,openid,"2");
            System.out.println("该粉丝所在分组为:"+groupid);
        } catch (WexinReqException e) {
            e.printStackTrace();
        }
    ...
    private static void testBatchGroupMemberMove(){
        ...
        try {
            ...
            String groupid = JwGroupUtils.batchGroupMemberMove(TOKEN,openidList,"101");
            System.out.println("该粉丝所在分组为:"+groupid);
        } catch (WexinReqException e) {
            e.printStackTrace();
        }
    ...
    private static void testGroupDelete(){
        try {
            String errmsg = JwGroupUtils.groupDelete(TOKEN,"129");
