...
import wfm.example.back.wx.model.menu.PersonalizedMenu;
import wfm.example.back.wx.model.menu.WeixinButton;
import wfm.example.back.wx.model.menu.WeixinMenuMatchrule;
 ...
 *
 */
public class JwPersonalizedMenuUtils {
    ...
    public static void main(String[] args) {
        ...
        String s = JwPersonalizedMenuUtils.createMenu("UpIJXAUIzENJnR9WDD3kxCErxtxnFHVT_Sd3kHmtiauJwUi2PU6u5YFUHgKibd2_wDBlR6xjmHzXfO5zvYEV9ljeJGrwCZOcokZOXpiu6V1gjEf4oOzMUliKFYUdukJzNBEiABAIWZ",menu);
        List<WeixinButton> s3 = JwPersonalizedMenuUtils.testMatchrule("UpIJXAUIzENJnR9WDD3kxCErxtxnFHVT_Sd3kHmtiauJwUi2PU6u5YFUHgKibd2_wDBlR6xjmHzXfO5zvYEV9ljeJGrwCZOcokZOXpiu6V1gjEf4oOzMUliKFYUdukJzNBEiABAIWZ","oGCDRjooOuBCr7MM0cs1-KqAh_aU");
