...
import wfm.example.back.wx.model.tag.WxTag;
import wfm.example.back.wx.model.tag.WxTagUser;
import wfm.example.back.wx.model.tag.WxTagUserList;
...
public class JwTagUtils {
    ...
    public static JSONObject createTag(String accessToken, String tagName) throws WexinReqException {
        ...
        if (accessToken != null) {
            ...
            obj.put("tag", map);
            log.info("创建标签方法执行前json参数---obj: "+obj.toString());
            result = WxstoreUtils.httpRequest(requestUrl, "POST", obj.toString());
            log.info("创建标签方法执行后json参数 : "+result.toString());
        }
        return result;
    }
    ...
    public static List<WxTag> getTags(String accessToken){
        ...
        if(accessToken != null){
            ...
            log.info("获取标签方法执行后json参数 : "+result.toString());
        }
        return list;
    }
    ...
    public static JSONObject updateTag(String accessToken,int id,String name){
        ...
        if(accessToken != null){
            ...
            JSONObject obj = new JSONObject();
            obj.put("tag", data);
            log.info("编辑标签方法执行前json参数---obj: "+obj.toString());
            result = WxstoreUtils.httpRequest(requestUrl, "POST", obj.toString());
            log.info("编辑标签方法执行后json参数 : "+result.toString());
        }
        return result;
    }
    ...
    public static JSONObject delete(String accessToken,String id){
        ...
        if(accessToken != null){
            ...
            JSONObject obj = new JSONObject();
            obj.put("tag", data);
            log.info("删除标签方法执行前json参数---obj: "+obj.toString());
            result = WxstoreUtils.httpRequest(requestUrl, "POST", obj.toString());
            log.info("删除标签方法执行后json参数 : "+result.toString());
        }
        return result;
    }
    ...
    public static WxTagUser getTagUser(String accessToken, int tagid, String next_openid){
        ...
        try {
            if(accessToken != null){
                ...
                log.info("获取标签下粉丝列表方法执行前json参数---obj: "+obj.toString());
                ...
                log.info("获取标签下粉丝列表方法执行后json参数 : "+result.toString());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static JSONObject batchtagging(String accessToken, List<String> openid_list, int tagid){
        ...
        if(accessToken != null){
            ...
            data.put("tagid", tagid);
            JSONObject obj = JSONObject.fromObject(data);
            log.info("批量为用户打标签 方法执行前json参数---obj: "+obj.toString());
            result = WxstoreUtils.httpRequest(requestUrl, "POST", obj.toString());
            log.info("批量为用户打标签 方法执行后json参数 : "+result.toString());
        }
        return result;
    }
    ...
    public static JSONObject batchuntagging(String accessToken,List<String> openid_list,int tagid){
        ...
        if(accessToken != null){
            ...
            data.put("tagid", tagid);
            JSONObject obj = JSONObject.fromObject(data);
            log.info("批量为用户取消标签 方法执行前json参数---obj: "+obj.toString());
            result = WxstoreUtils.httpRequest(requestUrl, "POST", obj.toString());
            log.info("批量为用户取消标签 方法执行后json参数 : "+result.toString());
        }
        return result;
    }
    ...
    public static List<Integer> getidlist(String accessToken,String openid){
        ...
        if(accessToken != null){
            ...
            JSONObject obj = JSONObject.fromObject(data);
            log.info("获取用户身上的标签列表 方法执行前json参数---obj: "+obj.toString());
            ...
            log.info("获取用户身上的标签列表 方法执行后json参数 : "+result.toString());
        }
        return list;
    }
