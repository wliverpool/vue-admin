...
import wfm.example.back.wx.constant.dingtalk.JdtTypes;
import wfm.example.back.wx.model.dingtalk.Department;
import wfm.example.back.wx.model.dingtalk.DeptParentResponse;
 ...
 */
@Slf4j
public class JdtDepartmentUtils {
    ...
    public static Response<Integer> create(Department department, String accessToken) {
        ...
        Response<JSONObject> originResponse = HttpUtils.post(url, JSON.toJSONString(department));
        ...
        log.info("[DEPART_CREATE] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<JSONObject> update(Department department, String accessToken) {
        ...
        Response<JSONObject> response = HttpUtils.post(url, JSON.toJSONString(department));
        log.info("[DEPART_UPDATE] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<JSONObject> delete(int dept_id, String accessToken) {
        ...
        Response<JSONObject> response = HttpUtils.post(url, body.toJSONString());
        log.info("[DEPART_DELETE] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static List<Response<JSONObject>> batchDeletePseudo(Collection<Integer> deptIds, String accessToken) {
        ...
        for (Integer deptId : deptIds) {
            list.add(JdtDepartmentUtils.delete(deptId, accessToken));
        }
        return list;
    }
    ...
    public static Response<List<Department>> listByRoot(String accessToken) {
        ...
        Response<List<Department>> response = HttpUtils.post(url, "", JdtTypes.List_Department);
        log.info("[DEPART_LIST_ROOT_SUB] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<List<Department>> listByParentId(int dept_id, String accessToken) {
        ...
        JSONObject body = new JSONObject();
        body.put("dept_id", dept_id);
        Response<List<Department>> response = HttpUtils.post(url, body.toJSONString(), JdtTypes.List_Department);
        log.info("[DEPART_LIST_SUB_BY_PARENT_ID] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<Department> getDepartmentById(int dept_id, String accessToken) {
        ...
        JSONObject body = new JSONObject();
        body.put("dept_id", dept_id);
        Response<Department> response = HttpUtils.post(url, body.toJSONString(), Department.class);
        log.info("[DEPART_GET_BY_ID] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<List<Integer>> getListSubId(int dept_id, String accessToken) {
        ...
        JSONObject body = new JSONObject();
        body.put("dept_id", dept_id);
        Response<JSONObject> originResponse = HttpUtils.post(url, body.toJSONString());
        ...
        log.info("[DEPART_GET_LIST_SUB_ID] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<List<DeptParentResponse>> getListParentByUser(String userid, String accessToken) {
        ...
        log.info("[DEPART_GET_LIST_PARENT_BY_USER] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<List<Integer>> getListParentByDept(String dept_id, String accessToken) {
        ...
        log.info("[DEPART_GET_LIST_PARENT_BY_DEPT] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static List<Department> listAll(String accessToken) {
        ...
        int topDepId = 1;
        // 先查出来顶级的部门
        Response<Department> response = JdtDepartmentUtils.getDepartmentById(topDepId, accessToken);
        if (response.isSuccess()) {
            all.add(response.getResult());
            JdtDepartmentUtils.listAllGetChildren(topDepId, accessToken, all);
        }
        return all;
    }
    ...
    public static List<Response<Department>> listAllResponse(String accessToken) {
        ...
        if (response.isSuccess()) {
            all.add(response.getResult());
            JdtDepartmentUtils.listAllGetChildren(topDepId, accessToken, all, res);
        }
        return res;
    }

    private static void listAllGetChildren(int parentDepId, String accessToken, List<Department> all) {
        JdtDepartmentUtils.listAllGetChildren(parentDepId, accessToken, all, null);
    }
    ...
    private static void listAllGetChildren(int parentDepId, String accessToken, List<Department> all, List<Response<Department>> res) {
        Response<List<Department>> response = JdtDepartmentUtils.listByParentId(parentDepId, accessToken);
        if (response.isSuccess()) {
            ...
            if (departments.size() != 0) {
                ...
                for (Department department : departments) {
                    ...
                    JdtDepartmentUtils.listAllGetChildren(department.getDept_id(), accessToken, all, res);
                }
            }
        } else if (res != null) {
