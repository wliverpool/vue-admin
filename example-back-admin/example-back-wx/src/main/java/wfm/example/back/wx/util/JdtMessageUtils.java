...
import wfm.example.back.wx.model.dingtalk.*;
...
public class JdtMessageUtils {
    ...
    private static <T extends SuperMessage> Response<String> sendMessage(Message<T> message, String accessToken, String logText) {
        ...
        log.info("[" + logText + "] params:{}", new Object[]{JSON.toJSONString(message)});
        JSONObject originResponse = HttpUtils.sendPost(url, JSON.toJSONString(message));
        ...
        log.info("[" + logText + "] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
    ...
    public static Response<String> sendTextMessage(Message<TextMessage> message, String accessToken) {
        return JdtMessageUtils.sendMessage(message, accessToken, "MSG_SEND_TEXT_MESSAGE");
    }
    ...
    public static Response<String> sendImageMessage(Message<ImageMessage> message, String accessToken) {
        return JdtMessageUtils.sendMessage(message, accessToken, "MSG_SEND_IMAGE_MESSAGE");
    }
    ...
    public static Response<String> sendVoiceMessage(Message<VoiceMessage> message, String accessToken) {
        return JdtMessageUtils.sendMessage(message, accessToken, "MSG_SEND_VOICE_MESSAGE");
    }
    ...
    public static Response<String> sendFileMessage(Message<FileMessage> message, String accessToken) {
        return JdtMessageUtils.sendMessage(message, accessToken, "MSG_SEND_FILE_MESSAGE");
    }
    ...
    public static Response<String> sendLinkMessage(Message<LinkMessage> message, String accessToken) {
        return JdtMessageUtils.sendMessage(message, accessToken, "MSG_SEND_LINK_MESSAGE");
    }
    ...
    public static Response<String> sendMarkdownMessage(Message<MarkdownMessage> message, String accessToken) {
        return JdtMessageUtils.sendMessage(message, accessToken, "MSG_SEND_MARKDOWN_MESSAGE");
    }
    ...
    public static Response<String> sendActionCardMessage(Message<ActionCardMessage> message, String accessToken) {
        return JdtMessageUtils.sendMessage(message, accessToken, "MSG_SEND_ACTION_CARD_MESSAGE");
    }
    ...
    public static Response<JSONObject> recallMessage(int agent_id, String msg_task_id, String accessToken) {
        ...
        log.info("[MSG_RECALL_MESSAGE] response:{}", new Object[]{JSON.toJSONString(response)});
        return response;
    }
