...
public class ActNodeServiceImpl extends ServiceImpl<ActNodeMapper, ActNode> implements IActNodeService {
    ...
    @Override
    public List<LoginUserDto> findUserByNodeId(String nodeId, String procDefId) {
        List<LoginUserDto> users = this.baseMapper.findUserByNodeId(nodeId,procDefId);
        if (users.size()==0) {
    ...
    @Override
    public List<RoleDto> findRoleByNodeId(String nodeId, String procDefId) {
        return this.baseMapper.findRoleByNodeId(nodeId,procDefId);
    }

    @Override
    public List<DepartmentDto> findDepartmentByNodeId(String nodeId, String procDefId) {
        return this.baseMapper.findDepartmentByNodeId(nodeId,procDefId);
    }

    @Override
    public List<DepartmentDto> findDepartmentManageByNodeId(String nodeId,String procDefId) {
    ...
    public List<String> findDepartmentIdsByNodeId(String nodeId,String procDefId) {
        List<DepartmentDto> departmentByNodeId = this.findDepartmentByNodeId(nodeId,procDefId);
        return departmentByNodeId.stream().map(DepartmentDto::getId).distinct().collect(Collectors.toList());
    }

    public List<LoginUserDto> queryAllUser() {
        return this.baseMapper.queryAllUser();
    }

    public List<LoginUserDto> findUserByRoleId(String id) {
        return this.baseMapper.findUserByRoleId(id);
    }

    public List<LoginUserDto> findUserDepartmentId(String id) {
        return this.baseMapper.findUserDepartmentId(id);
    }
    public List<LoginUserDto> findUserDepartmentManageId(String id) {
    ...
    public Boolean getCurrenLineConditionResule(PvmTransition outTransition, Map<String, Object> variables) {
        ...
        // 获取线路判断条件信息
        Object conStr = outTransition.getProperty("conditionText");
