...
public class TreeVo {
    ...
    public TreeVo(String id, String icon, String parentId, String name, boolean isLeaf) {
        this.key = id;
        this.icon = icon;
    ...
    public TreeVo(String key, String parentId, String slotTitle, Integer ruleFlag, boolean isLeaf) {
        this.key = key;
        this.parentId = parentId;
    ...
    public TreeVo(SysPermission permission) {
